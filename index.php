        ...
        <div class="card rounded-0 border-0">
          <div class="card-body p-0">
             ...
             <div class="text-center my-4">
               <h5 class="text-dark fw-bold">DIGITAL SOFTWARE ARENA </h5>
               <p class="mb-0">Digital Software Arena we provide pure product from the biggest brands all over the world </p>
             </div>
             <div class="d-grid">
                <a href="home.php" class="btn btn-dark btn-ecomm rounded-3">Get Started</a>   
             </div>
          </div>
        </div>
