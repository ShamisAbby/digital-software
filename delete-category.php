                  ...
                  <div class="card-body">
                    <div class="d-flex flex-row align-items-center justify-content-between">
                      <div class="category-name">
                        <h6 class="mb-0 fw-bold text-dark fs-5"><?php echo $row['category_name']; ?></h6>
                        <a class="mb-0 fw-bold fs-5 mt-2 text-danger" href="./handler/delete-category.php?id=<?php echo $row['category_id']; ?>" onclick="return confirm('Are sure you want to delete <?php echo $row['category_name']; ?> ?')">Delete</a>
                      </div>
